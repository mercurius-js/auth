...
class Auth {
  ...
  [kMakeProtectedResolver] (authDirectiveAST, resolverFn) {
    return async (parent, args, context, info) => {
      ...
      // HERE:: IF WE CHANGE THIS TO this[kApplyPolicy]({ authDirectiveAST, parent, args, context, info })
      // THEN WE CAN DESTRUCTURE THE REQUIRED PARAMETERS AND IGNORE REST UNUSED PARAMETERS
