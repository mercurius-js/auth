...
const { isObjectType, isInterfaceType, isInputObjectType, isUnionType } = require('graphql/index')
            ...
            if (fieldName === '__typePolicy') {
              ...
              if (typeof schemaTypeField !== 'undefined') {
                if (typeof opts !== 'undefined' && !opts.enabled) {
                  ...
                  // @todo we need to add a check here make sure it's a string.... there is no graphql "isStringType".
                  if (!isNonNullType(schemaTypeField.type) && valueOverride !== null) {
